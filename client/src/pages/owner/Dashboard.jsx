...
const Dashboard = () => {
  ...
  return (
    <div className='px-4 pt-10 md:mx-10 flex-1'>
      <Title title='Admin Dashboard' subtitle='Track system activity and manage everything in one place.' />
      ...
      <div className='flex flex-wrap items-start gap-6 mb-8 w-full'>
        ...
        <div className='p-4 md:p-6 border border-borderColor rounded-md max-w-lg w-full'>
          ...
          <p className='text-gray-500'>Current Customer Bookings</p>

          {data.recentBookings.length > 0 ? (
            data.recentBookings.map((booking, index) => (
              <div key={index} className='mt-4 flex items-center justify-between'>
                <div className='flex items-center gap-2'>
                  <div className='hidden md:flex items-center justify-center w-12 h-12 rounded-full bg-black/10'>
        ...
        <div className='p-4 md:p-6 mb-6 border border-borderColor rounded-md w-full md:max-w-xs'>
          ...
          <p className='text-gray-500'>Revenue for this month</p>
          <p className='text-3xl mt-6 font-semibold text-black'>
